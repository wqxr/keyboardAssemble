...
import { IOList,IOListA } from '../../common/bean/Pointdata';
      ...
      getPointfun(station:number,xPoint:number,yPoint:number,zPoint:number,name:string){
        for(let i=0;i<this.iOList.length;i++){
          if(this.iOList[i].index===station){
            ...
            let pointinfoold=this.IOListAold[i].pointinfo;
    ...
    savePoint(){
      ...
      for(let i=0;i<this.iOList.length;i++){
          for(let j=0;j<this.iOList[i].pointinfo.length;j++){
            ...
            this.ipcService.send("setPoint", {"stationname":stationname,"station":stationid,"pointname":name,"xPoint":this.iOList[i].pointinfo[j].xpoint,"yPoint":this.iOList[i].pointinfo[j].ypoint,"zPoint":this.iOList[i].pointinfo[j].zpoint,"prexpoint":this.IOListAold[i].pointinfo[j].xpoint,"totalpoint":this.iOList[i].pointinfo[j].total,"change":"x"});
          ...
          if(this.iOList[i].pointinfo[j].ypoint!==this.IOListAold[i].pointinfo[j].ypoint){
            ...
            let name=this.iOList[i].pointinfo[j].name;
            let stationname=this.iOList[i].name;
            this.ipcService.send("setPoint", {"stationname":stationname,"station":stationid,"pointname":name,"xPoint":this.iOList[i].pointinfo[j].xpoint,"yPoint":this.iOList[i].pointinfo[j].ypoint,"zPoint":this.iOList[i].pointinfo[j].zpoint,"prexpoint":this.IOListAold[i].pointinfo[j].ypoint,"totalpoint":this.iOList[i].pointinfo[j].total,"change":"y"});
        ...
        if(this.iOList[i].pointinfo[j].zpoint!==this.IOListAold[i].pointinfo[j].zpoint){
          ...
          let name=this.iOList[i].pointinfo[j].name;
          let stationname=this.iOList[i].name;
          this.ipcService.send("setPoint", {"stationname":stationname,"station":stationid,"pointname":name,"xPoint":this.iOList[i].pointinfo[j].xpoint,"yPoint":this.iOList[i].pointinfo[j].ypoint,"zPoint":this.iOList[i].pointinfo[j].zpoint,"prexpoint":this.IOListAold[i].pointinfo[j].zpoint,"totalpoint":this.iOList[i].pointinfo[j].total,"change":"z"});
